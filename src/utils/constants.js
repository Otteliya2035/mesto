...
export const popupCloseProfile = document.querySelector(".popup__close-profile");
export const popupEditProfile = document.querySelector(".popup_edit-profile");
export const formElementEditProfile = document.querySelector(".popup__form-profile");
...
export const cardTemplate = document
  ...
  export const inputNewPlace = document.querySelector(".popup__field_input_new-place");
  export const inputLinkPic = document.querySelector(".popup__field_input_link-pic");
  ...
  export const avatarPopupOpenButton = document.querySelector(".profile__avatar-btn");
